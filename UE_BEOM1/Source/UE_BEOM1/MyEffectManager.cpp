...
AMyEffectManager::AMyEffectManager()
{
	...
	CreateParticleClass(TEXT("DaggerAttack"), TEXT("/Script/Engine.Blueprint'/Game/BluePrint/Effect/Effect_BP.Effect_BP_C'"));
}
...
void AMyEffectManager::CreateParticleClass(FString name, FString path)
{
	...
	static ConstructorHelpers::FClassFinder<AMyEffect> effect(*path); // TODO : static Á¦°Å
	if (effect.Succeeded())
	{
